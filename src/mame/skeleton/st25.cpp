...
RAM: Mosel-Vitelic V62C518256LL-70P 32Kx8 SRAM
 ...
 Unimint Arena reference: https://www.youtube.com/watch?v=EEvGKFtBhi8
 Xeno reference: https://www.youtube.com/watch?v=EGBh0htXmbc
...
static INPUT_PORTS_START(st25)
	...
	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_KEYPAD) PORT_CODE(KEYCODE_3_PAD) PORT_NAME("3")
	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_KEYPAD) PORT_CODE(KEYCODE_4_PAD) PORT_NAME("4")
	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_KEYPAD) PORT_CODE(KEYCODE_5_PAD) PORT_NAME("5")
	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_KEYPAD) PORT_CODE(KEYCODE_6_PAD) PORT_NAME("6")
	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_UNUSED )
	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_UNUSED )

	PORT_START("SERVICE1")
	PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_KEYPAD) PORT_CODE(KEYCODE_7_PAD) PORT_NAME("7")
	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_KEYPAD) PORT_CODE(KEYCODE_8_PAD) PORT_NAME("8")
	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_KEYPAD) PORT_CODE(KEYCODE_9_PAD) PORT_NAME("9")
	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_KEYPAD) PORT_CODE(KEYCODE_ASTERISK) PORT_NAME("*")
	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_KEYPAD) PORT_CODE(KEYCODE_0_PAD) PORT_NAME("0")
	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_KEYPAD) PORT_CODE(KEYCODE_ENTER_PAD) PORT_NAME("#")
	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_UNUSED )
	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_UNUSED )
	...
	PORT_BIT( 0x20, IP_ACTIVE_HIGH, IPT_GAMBLE_LOW )
...
ROM_START(cttower)
	...
	ROM_REGION(0x200000, "oki", ROMREGION_ERASEFF)
	ROM_LOAD("panther_city_tower_musik.ic1", 0x00000, 0x80000, CRC(0dcf91a7) SHA1(2e29b55c83bfd649dd92c087eeaa887676755e9f))
	ROM_RELOAD(0x100000, 0x80000)
ROM_END
...
ROM_START(jamaica)
	...
	ROM_REGION(0x200000, "oki", ROMREGION_ERASEFF)
	ROM_LOAD("panther_jamaica_musik.ic1", 0x00000, 0x80000, CRC(7dee50d4) SHA1(1d96ee159b07db84c4f0373f5df4df648ecef786))
	ROM_RELOAD(0x100000, 0x80000)
ROM_END
