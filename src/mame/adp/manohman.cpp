...
ROM_START( backgamn )
	...
	ROM_REGION( 0x4000, "nvram", 0 ) // crafted by running the initialization
	ROM_LOAD( "backgammon_nvram.bin", 0x0000, 0x4000, CRC(a8e9f0e4) SHA1(685ad479f836594db33e2b59f6f88ea25a5effbf) )
ROM_END
...
ROM_START( backgamnw )
	...
	ROM_REGION( 0x4000, "nvram", 0 ) // crafted by running the initialization
	ROM_LOAD( "backgammon_wand_nvram.bin", 0x0000, 0x4000, CRC(f273ded5) SHA1(eb7702235febce95efa0ed5e6fea5daf2c447853) )
ROM_END
