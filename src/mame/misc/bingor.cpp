...
{
   map(0x0000, 0x0010).rw("uart", FUNC(i8256_device::read),FUNC(i8256_device::write)).umask16(0x00ff);
...
void bingor_state::bingor(machine_config &config)
{
   ...
   I8256(config, "uart", XTAL(10'240'000) / 2);

	PIC16C57(config, "pic", XTAL(10'240'000)); //?? Mhz
