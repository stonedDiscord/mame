...
// TODO: investigate NEWTON_LOOPS
	...
	//VSYNC
	#if (FAST_VSYNC)
	CLOCK(VSYNC_CLOCK, 60)
	NET_C(VSYNC_CLOCK.GND, GND)
	NET_C(VSYNC_CLOCK.VCC, VCC)
	ALIAS(vsync, VSYNC_CLOCK.Q)
	#else
	CAP(C6, CAP_P(100))
	CAP(C9_1, CAP_U(100))
	CAP(C9_2, CAP_U(100))
	...
	//HSYNC
	#if (FAST_HSYNC)
	CLOCK(HSYNC_CLOCK, 15.734)
	NET_C(HSYNC_CLOCK.GND, GND)
	NET_C(HSYNC_CLOCK.VCC, VCC)
	ALIAS(hsync, HSYNC_CLOCK.Q)
	#else
	CAP(C10_1, CAP_P(470))
	CAP(C10_2, CAP_P(680))
	CAP(C10_3, CAP_P(10))
	...
	NET_C(D7.K, R4_3.1)
	NET_C(vsync, D8_2.A, D7_2.A, D6_2.A, D5_2.A)
	NET_C(hsync, D8_1.A, D7_1.A)
