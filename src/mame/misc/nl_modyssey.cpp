...
NETLIST_START(modyssey)
{
	...
	NET_MODEL("NTE5013A  D(BV=6.2 IBV=0.020 NBV=1)") // Zener diode, 6.2V
	NET_MODEL("NTE5014A  D(BV=6.8 IBV=0.020 NBV=1)") // Zener diode, 6.8V
	...
	QBJT_EB(Q1, "142N9")
	RES(R45, RES_K(1.5))
	NET_C(VCC, Q1.E, C14.1)
	NET_C(GND, Z1.A, C14.2, C13.2, C15.2)
	...
	POT(RV4, 15000)
	POT(RV6, 50000)
	NET_C(VCC, R30.2, R33.2, R7.2, R5.2, R21.2, R15.2, R20.1, R18.2, R29.2, R27.2)
	NET_C(GND, C10.2, R13.1, C1.2, C16.2, C11.2, Q2.E, R46.1, Z2.A, C20.2, C3.2, C4.2, R19.2, RV12.2, RV12.3, C5.2, C9.2, C8.2, C7.2)
